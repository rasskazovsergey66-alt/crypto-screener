...
|---|---|---|---|
| **23.09.2026 19:29 UTC** | **135** | **25.7 КБ** | **37** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260923_192958.csv`](./crypto_screener_20260923_192958.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `84 404,09 USD` | −2,45% | 1,7 T USD | 43,2 B USD |
| **2** | **ETH** | `2 672,72 USD` | −3,29% | 326,27 B USD | 17,85 B USD |
| **3** | **USDT** | `0,99980 USD` | −0,02% | 183,43 B USD | 101,7 B USD |
| **4** | **BNB** | `767,27 USD` | −2,79% | 102,17 B USD | 1,95 B USD |
| **5** | **XRP** | `1,4987 USD` | −6,55% | 94,24 B USD | 8,32 B USD |
| **6** | **USDC** | `0,99994 USD` | 🟢 +0,02% | 75,22 B USD | 21,39 B USD |
| **7** | **SOL** | `114,46 USD` | −3,52% | 67,25 B USD | 5,17 B USD |
| **8** | **TRX** | `0,34020 USD` | −0,49% | 32,31 B USD | 535,6 M USD |
| **9** | **ZEC** | `1 523,37 USD` | −0,16% | 25,72 B USD | 2,42 B USD |
| **10** | **HYPE** | `93,768 USD` | −3,05% | 23,56 B USD | 1,18 B USD |
