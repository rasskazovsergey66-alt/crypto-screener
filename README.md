...
|---|---|---|---|
| **24.09.2026 04:48 UTC** | **135** | **25.8 КБ** | **38** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260924_044808.csv`](./crypto_screener_20260924_044808.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `83 799,17 USD` | −3,88% | 1,68 T USD | 46,07 B USD |
| **2** | **ETH** | `2 673,35 USD` | −3,97% | 326,35 B USD | 17,41 B USD |
| **3** | **USDT** | `0,99977 USD` | −0,01% | 183,5 B USD | 101,76 B USD |
| **4** | **BNB** | `768,62 USD` | −3,60% | 102,35 B USD | 1,95 B USD |
| **5** | **XRP** | `1,4923 USD` | −9,70% | 93,83 B USD | 7,59 B USD |
| **6** | **USDC** | `0,99987 USD` | −0,01% | 75,41 B USD | 21,74 B USD |
| **7** | **SOL** | `114,80 USD` | −4,00% | 67,45 B USD | 5,26 B USD |
| **8** | **TRX** | `0,34326 USD` | −0,33% | 32,6 B USD | 554,19 M USD |
| **9** | **ZEC** | `1 509,22 USD` | −5,59% | 25,48 B USD | 2,22 B USD |
| **10** | **HYPE** | `91,891 USD` | −5,77% | 23,09 B USD | 1,12 B USD |
