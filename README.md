...
|---|---|---|---|
| **18.09.2026 04:12 UTC** | **135** | **25.8 КБ** | **12** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260918_041214.csv`](./crypto_screener_20260918_041214.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `77 181,04 USD` | 🟢 +1,21% | 1,55 T USD | 21,43 B USD |
| **2** | **ETH** | `2 471,63 USD` | 🟢 +1,73% | 301,68 B USD | 11,5 B USD |
| **3** | **USDT** | `0,99914 USD` | 🟢 +0,01% | 183,28 B USD | 58,7 B USD |
| **4** | **BNB** | `748,98 USD` | 🟢 +3,42% | 99,73 B USD | 1,47 B USD |
| **5** | **XRP** | `1,3192 USD` | 🟢 +1,57% | 82,95 B USD | 2,5 B USD |
| **6** | **USDC** | `0,9999 USD` | −0,02% | 73,93 B USD | 12,98 B USD |
| **7** | **SOL** | `104,41 USD` | 🟢 +4,86% | 61,31 B USD | 3,01 B USD |
| **8** | **TRX** | `0,33591 USD` | 🟢 +0,10% | 31,9 B USD | 306,48 M USD |
| **9** | **ZEC** | `1 510,61 USD` | 🟢 +10,43% | 25,49 B USD | 2,72 B USD |
| **10** | **HYPE** | `86,565 USD` | 🟢 +9,19% | 21,77 B USD | 1,12 B USD |
