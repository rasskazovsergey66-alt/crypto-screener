...
|---|---|---|---|
| **20.09.2026 05:32 UTC** | **135** | **25.7 КБ** | **21** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260920_053222.csv`](./crypto_screener_20260920_053222.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `80 540,69 USD` | −0,65% | 1,62 T USD | 20,33 B USD |
| **2** | **ETH** | `2 578,93 USD` | −1,98% | 314,8 B USD | 9,81 B USD |
| **3** | **USDT** | `0,99965 USD` | −0,00% | 183,32 B USD | 59,37 B USD |
| **4** | **BNB** | `749,70 USD` | −1,78% | 99,83 B USD | 1,52 B USD |
| **5** | **XRP** | `1,3815 USD` | −3,44% | 86,87 B USD | 3,7 B USD |
| **6** | **USDC** | `0,99987 USD` | −0,01% | 74,23 B USD | 9,88 B USD |
| **7** | **SOL** | `108,94 USD` | −3,42% | 63,99 B USD | 2,92 B USD |
| **8** | **TRX** | `0,34017 USD` | 🟢 +0,59% | 32,3 B USD | 384,91 M USD |
| **9** | **ZEC** | `1 446,82 USD` | −6,61% | 24,42 B USD | 1,32 B USD |
| **10** | **HYPE** | `90,975 USD` | −1,36% | 22,88 B USD | 973,66 M USD |
