...
|---|---|---|---|
| **16.09.2026 09:36 UTC** | **135** | **26.2 КБ** | **5** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260916_093627.csv`](./crypto_screener_20260916_093627.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `75 807,93 USD` | −1,48% | 1,52 T USD | 38,93 B USD |
| **2** | **ETH** | `2 400,19 USD` | −3,07% | 292,95 B USD | 19,33 B USD |
| **3** | **USDT** | `0,99910 USD` | −0,06% | 183,28 B USD | 80,69 B USD |
| **4** | **BNB** | `709,43 USD` | −1,13% | 94,47 B USD | 1,53 B USD |
| **5** | **XRP** | `1,2868 USD` | −8,16% | 80,91 B USD | 6,68 B USD |
| **6** | **USDC** | `1,0000 USD` | ⚪ 0,00% | 73,73 B USD | 19,52 B USD |
| **7** | **SOL** | `97,083 USD` | −3,67% | 56,99 B USD | 3,77 B USD |
| **8** | **TRX** | `0,33473 USD` | −1,18% | 31,78 B USD | 521,84 M USD |
| **9** | **ZEC** | `1 189,03 USD` | 🟢 +4,34% | 20,06 B USD | 1,17 B USD |
| **10** | **HYPE** | `77,633 USD` | −1,82% | 19,53 B USD | 858,65 M USD |
