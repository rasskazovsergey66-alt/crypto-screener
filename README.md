...
|---|---|---|---|
| **25.09.2026 05:12 UTC** | **135** | **25.8 КБ** | **42** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260925_051240.csv`](./crypto_screener_20260925_051240.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `84 169,75 USD` | −0,02% | 1,69 T USD | 36,74 B USD |
| **2** | **ETH** | `2 678,01 USD` | −0,51% | 326,93 B USD | 13,92 B USD |
| **3** | **USDT** | `0,99973 USD` | −0,01% | 183,73 B USD | 82,65 B USD |
| **4** | **BNB** | `773,10 USD` | −0,08% | 102,95 B USD | 1,58 B USD |
| **5** | **XRP** | `1,5328 USD` | 🟢 +1,36% | 96,38 B USD | 4,88 B USD |
| **6** | **USDC** | `0,99981 USD` | −0,00% | 75,39 B USD | 17,82 B USD |
| **7** | **SOL** | `116,27 USD` | 🟢 +0,58% | 68,33 B USD | 3,98 B USD |
| **8** | **TRX** | `0,33874 USD` | −1,37% | 32,17 B USD | 473,81 M USD |
| **9** | **ZEC** | `1 544,06 USD` | 🟢 +0,91% | 26,07 B USD | 1,25 B USD |
| **10** | **HYPE** | `91,641 USD` | −1,14% | 23,02 B USD | 1,29 B USD |
