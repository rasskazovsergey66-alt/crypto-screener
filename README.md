...
|---|---|---|---|
| **23.09.2026 09:08 UTC** | **135** | **25.7 КБ** | **35** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260923_090829.csv`](./crypto_screener_20260923_090829.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `85 986,21 USD` | 🟢 +0,18% | 1,73 T USD | 38,65 B USD |
| **2** | **ETH** | `2 740,72 USD` | 🟢 +0,19% | 334,57 B USD | 14,8 B USD |
| **3** | **USDT** | `0,99982 USD` | 🟢 +0,01% | 183,44 B USD | 91,34 B USD |
| **4** | **BNB** | `788,04 USD` | 🟢 +0,47% | 104,94 B USD | 1,82 B USD |
| **5** | **XRP** | `1,6009 USD` | 🟢 +4,57% | 100,66 B USD | 7,41 B USD |
| **6** | **USDC** | `0,99994 USD` | −0,01% | 75,21 B USD | 17,62 B USD |
| **7** | **SOL** | `117,44 USD` | 🟢 +0,58% | 69 B USD | 4,3 B USD |
| **8** | **TRX** | `0,34302 USD` | −1,51% | 32,57 B USD | 621,25 M USD |
| **9** | **ZEC** | `1 613,55 USD` | 🟢 +7,94% | 27,24 B USD | 1,99 B USD |
| **10** | **HYPE** | `95,932 USD` | 🟢 +1,09% | 24,11 B USD | 1,15 B USD |
