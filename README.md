...
|---|---|---|---|
| **20.09.2026 17:07 UTC** | **135** | **26.1 КБ** | **23** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260920_170733.csv`](./crypto_screener_20260920_170733.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `81 383,12 USD` | −0,47% | 1,63 T USD | 21,26 B USD |
| **2** | **ETH** | `2 646,51 USD` | −0,20% | 323,05 B USD | 9,08 B USD |
| **3** | **USDT** | `0,99967 USD` | −0,00% | 183,32 B USD | 57,34 B USD |
| **4** | **BNB** | `763,90 USD` | −0,56% | 101,72 B USD | 1,47 B USD |
| **5** | **XRP** | `1,4129 USD` | −1,82% | 88,84 B USD | 2,9 B USD |
| **6** | **USDC** | `0,99990 USD` | ⚪ +0,00% | 74,21 B USD | 9,36 B USD |
| **7** | **SOL** | `110,37 USD` | −1,56% | 64,83 B USD | 2,86 B USD |
| **8** | **TRX** | `0,34414 USD` | 🟢 +1,35% | 32,68 B USD | 442,25 M USD |
| **9** | **ZEC** | `1 448,92 USD` | −3,63% | 24,46 B USD | 1,22 B USD |
| **10** | **HYPE** | `93,148 USD` | −0,17% | 23,42 B USD | 793,73 M USD |
