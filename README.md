...
|---|---|---|---|
| **21.09.2026 09:41 UTC** | **135** | **26.0 КБ** | **26** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260921_094139.csv`](./crypto_screener_20260921_094139.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `84 871,98 USD` | 🟢 +5,41% | 1,7 T USD | 21,55 B USD |
| **2** | **ETH** | `2 736,84 USD` | 🟢 +5,90% | 334,08 B USD | 12,8 B USD |
| **3** | **USDT** | `0,99979 USD` | 🟢 +0,02% | 183,35 B USD | 61,68 B USD |
| **4** | **BNB** | `784,66 USD` | 🟢 +4,31% | 104,49 B USD | 1,74 B USD |
| **5** | **XRP** | `1,4822 USD` | 🟢 +6,86% | 93,2 B USD | 2,84 B USD |
| **6** | **USDC** | `0,99982 USD` | −0,01% | 74,28 B USD | 11,84 B USD |
| **7** | **SOL** | `116,22 USD` | 🟢 +7,03% | 68,27 B USD | 3,41 B USD |
| **8** | **TRX** | `0,34432 USD` | 🟢 +0,79% | 32,7 B USD | 460,4 M USD |
| **9** | **ZEC** | `1 498,83 USD` | 🟢 +3,40% | 25,3 B USD | 1,43 B USD |
| **10** | **HYPE** | `95,709 USD` | 🟢 +4,94% | 24,07 B USD | 832,29 M USD |
