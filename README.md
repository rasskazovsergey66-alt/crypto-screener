...
|---|---|---|---|
| **22.09.2026 19:36 UTC** | **135** | **25.8 КБ** | **33** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260922_193614.csv`](./crypto_screener_20260922_193614.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `86 467,88 USD` | −0,13% | 1,74 T USD | 43,42 B USD |
| **2** | **ETH** | `2 758,53 USD` | −0,29% | 336,74 B USD | 16,58 B USD |
| **3** | **USDT** | `0,99997 USD` | ⚪ +0,00% | 183,38 B USD | 96,79 B USD |
| **4** | **BNB** | `789,05 USD` | −1,33% | 105,07 B USD | 2,05 B USD |
| **5** | **XRP** | `1,5970 USD` | 🟢 +6,24% | 100,42 B USD | 7,34 B USD |
| **6** | **USDC** | `0,99973 USD` | ⚪ 0,00% | 74,96 B USD | 18,65 B USD |
| **7** | **SOL** | `118,56 USD` | 🟢 +0,31% | 69,65 B USD | 5,01 B USD |
| **8** | **TRX** | `0,34154 USD` | −0,78% | 32,43 B USD | 697,5 M USD |
| **9** | **ZEC** | `1 528,62 USD` | 🟢 +3,85% | 25,81 B USD | 1,65 B USD |
| **10** | **HYPE** | `96,706 USD` | 🟢 +3,60% | 24,31 B USD | 1,18 B USD |
