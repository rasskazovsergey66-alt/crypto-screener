...
|---|---|---|---|
| **22.09.2026 17:35 UTC** | **135** | **25.8 КБ** | **32** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260922_173559.csv`](./crypto_screener_20260922_173559.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `86 574,02 USD` | 🟢 +0,80% | 1,74 T USD | 44,39 B USD |
| **2** | **ETH** | `2 756,80 USD` | 🟢 +0,35% | 336,52 B USD | 18,31 B USD |
| **3** | **USDT** | `0,99987 USD` | −0,01% | 183,36 B USD | 101,71 B USD |
| **4** | **BNB** | `787,96 USD` | −1,02% | 104,92 B USD | 2,27 B USD |
| **5** | **XRP** | `1,5708 USD` | 🟢 +4,95% | 98,77 B USD | 7,11 B USD |
| **6** | **USDC** | `0,99983 USD` | 🟢 +0,01% | 74,94 B USD | 19,8 B USD |
| **7** | **SOL** | `117,99 USD` | 🟢 +0,37% | 69,32 B USD | 5,45 B USD |
| **8** | **TRX** | `0,34132 USD` | −0,83% | 32,41 B USD | 698,47 M USD |
| **9** | **ZEC** | `1 553,26 USD` | 🟢 +4,91% | 26,22 B USD | 1,6 B USD |
| **10** | **HYPE** | `96,667 USD` | 🟢 +4,32% | 24,3 B USD | 1,2 B USD |
