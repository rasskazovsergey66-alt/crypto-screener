...
|---|---|---|---|
| **20.09.2026 18:31 UTC** | **135** | **26.0 КБ** | **24** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260920_183131.csv`](./crypto_screener_20260920_183131.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `81 268,44 USD` | −0,20% | 1,63 T USD | 21,37 B USD |
| **2** | **ETH** | `2 638,12 USD` | −0,04% | 322,02 B USD | 9,79 B USD |
| **3** | **USDT** | `0,99972 USD` | ⚪ +0,00% | 183,33 B USD | 58,39 B USD |
| **4** | **BNB** | `771,23 USD` | 🟢 +0,91% | 102,7 B USD | 1,47 B USD |
| **5** | **XRP** | `1,4109 USD` | −1,14% | 88,72 B USD | 2,83 B USD |
| **6** | **USDC** | `0,99988 USD` | 🟢 +0,01% | 74,2 B USD | 9,52 B USD |
| **7** | **SOL** | `110,30 USD` | −0,66% | 64,79 B USD | 3,11 B USD |
| **8** | **TRX** | `0,34359 USD` | 🟢 +1,38% | 32,63 B USD | 479,24 M USD |
| **9** | **ZEC** | `1 482,57 USD` | 🟢 +0,01% | 25,02 B USD | 1,22 B USD |
| **10** | **HYPE** | `92,843 USD` | 🟢 +0,77% | 23,35 B USD | 830,83 M USD |
