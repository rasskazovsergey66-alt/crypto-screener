...
|---|---|---|---|
| **25.09.2026 17:42 UTC** | **135** | **26.1 КБ** | **44** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260925_174231.csv`](./crypto_screener_20260925_174231.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `83 789,49 USD` | −0,42% | 1,68 T USD | 36,17 B USD |
| **2** | **ETH** | `2 686,82 USD` | 🟢 +0,58% | 328 B USD | 14,6 B USD |
| **3** | **USDT** | `0,99976 USD` | 🟢 +0,01% | 183,73 B USD | 85,15 B USD |
| **4** | **BNB** | `773,42 USD` | −0,64% | 102,99 B USD | 1,7 B USD |
| **5** | **XRP** | `1,5659 USD` | 🟢 +2,43% | 98,46 B USD | 6,38 B USD |
| **6** | **USDC** | `0,99984 USD` | −0,02% | 75,28 B USD | 18,14 B USD |
| **7** | **SOL** | `121,01 USD` | 🟢 +3,70% | 71,11 B USD | 5,18 B USD |
| **8** | **TRX** | `0,33755 USD` | −0,97% | 32,06 B USD | 446,36 M USD |
| **9** | **ZEC** | `1 533,82 USD` | −0,64% | 25,9 B USD | 1,33 B USD |
| **10** | **HYPE** | `91,342 USD` | −1,90% | 22,95 B USD | 1,15 B USD |
