...
|---|---|---|---|
| **21.09.2026 17:23 UTC** | **135** | **26.2 КБ** | **28** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260921_172309.csv`](./crypto_screener_20260921_172309.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `85 776,32 USD` | 🟢 +5,61% | 1,72 T USD | 36,86 B USD |
| **2** | **ETH** | `2 748,22 USD` | 🟢 +4,53% | 335,47 B USD | 18,54 B USD |
| **3** | **USDT** | `0,99991 USD` | 🟢 +0,02% | 183,37 B USD | 85,36 B USD |
| **4** | **BNB** | `795,76 USD` | 🟢 +4,43% | 105,96 B USD | 2,1 B USD |
| **5** | **XRP** | `1,4935 USD` | 🟢 +6,53% | 93,91 B USD | 4,31 B USD |
| **6** | **USDC** | `0,99967 USD` | −0,02% | 74,51 B USD | 16,5 B USD |
| **7** | **SOL** | `117,48 USD` | 🟢 +7,03% | 69,01 B USD | 4,77 B USD |
| **8** | **TRX** | `0,34406 USD` | 🟢 +0,21% | 32,67 B USD | 446,69 M USD |
| **9** | **ZEC** | `1 478,68 USD` | 🟢 +1,92% | 24,96 B USD | 1,52 B USD |
| **10** | **HYPE** | `92,939 USD` | 🟢 +0,34% | 23,37 B USD | 1 B USD |
