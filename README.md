...
|---|---|---|---|
| **16.09.2026 17:46 UTC** | **135** | **26.1 КБ** | **7** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260916_174640.csv`](./crypto_screener_20260916_174640.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `75 449,83 USD` | −2,00% | 1,52 T USD | 32,6 B USD |
| **2** | **ETH** | `2 376,33 USD` | −2,63% | 290,04 B USD | 16,87 B USD |
| **3** | **USDT** | `0,99921 USD` | −0,02% | 183,3 B USD | 71,68 B USD |
| **4** | **BNB** | `711,28 USD` | −1,74% | 94,71 B USD | 1,48 B USD |
| **5** | **XRP** | `1,2547 USD` | −10,91% | 78,89 B USD | 5,83 B USD |
| **6** | **USDC** | `1,0000 USD` | −0,04% | 73,67 B USD | 17,79 B USD |
| **7** | **SOL** | `96,341 USD` | −4,10% | 56,57 B USD | 3,4 B USD |
| **8** | **TRX** | `0,33524 USD` | 🟢 +0,14% | 31,83 B USD | 462,82 M USD |
| **9** | **ZEC** | `1 241,02 USD` | 🟢 +8,80% | 20,94 B USD | 1,64 B USD |
| **10** | **HYPE** | `78,099 USD` | 🟢 +0,34% | 19,65 B USD | 857,05 M USD |
