...
|---|---|---|---|
| **15.09.2026 11:33 UTC** | **135** | **26.2 КБ** | **4** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260915_143348.csv`](./crypto_screener_20260915_143348.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `75 830,08 USD` | −1,48% | 1,52 T USD | 38,93 B USD |
| **2** | **ETH** | `2 401,48 USD` | −3,03% | 293,11 B USD | 19,33 B USD |
| **3** | **USDT** | `0,99910 USD` | −0,06% | 183,28 B USD | 80,69 B USD |
| **4** | **BNB** | `709,92 USD` | −0,99% | 94,53 B USD | 1,53 B USD |
| **5** | **XRP** | `1,2875 USD` | −8,18% | 80,96 B USD | 6,68 B USD |
| **6** | **USDC** | `1,0000 USD` | −0,01% | 73,73 B USD | 19,52 B USD |
| **7** | **SOL** | `97,090 USD` | −3,57% | 57 B USD | 3,77 B USD |
| **8** | **TRX** | `0,33476 USD` | −0,94% | 31,79 B USD | 521,84 M USD |
| **9** | **ZEC** | `1 190,83 USD` | 🟢 +4,41% | 20,09 B USD | 1,17 B USD |
| **10** | **HYPE** | `77,638 USD` | −1,86% | 19,54 B USD | 858,65 M USD |
