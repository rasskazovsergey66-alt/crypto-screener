...
|---|---|---|---|
| **23.09.2026 06:23 UTC** | **135** | **25.8 КБ** | **34** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260923_062359.csv`](./crypto_screener_20260923_062359.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `86 502,13 USD` | 🟢 +1,48% | 1,74 T USD | 38,65 B USD |
| **2** | **ETH** | `2 758,52 USD` | 🟢 +1,22% | 336,74 B USD | 14,8 B USD |
| **3** | **USDT** | `0,99981 USD` | ⚪ +0,00% | 183,44 B USD | 91,34 B USD |
| **4** | **BNB** | `792,07 USD` | 🟢 +0,77% | 105,47 B USD | 1,82 B USD |
| **5** | **XRP** | `1,6213 USD` | 🟢 +7,10% | 101,95 B USD | 7,41 B USD |
| **6** | **USDC** | `0,99997 USD` | ⚪ +0,00% | 75,27 B USD | 17,62 B USD |
| **7** | **SOL** | `118,83 USD` | 🟢 +2,09% | 69,81 B USD | 4,3 B USD |
| **8** | **TRX** | `0,34397 USD` | −1,40% | 32,66 B USD | 621,25 M USD |
| **9** | **ZEC** | `1 613,29 USD` | 🟢 +9,28% | 27,24 B USD | 1,99 B USD |
| **10** | **HYPE** | `97,579 USD` | 🟢 +4,48% | 24,53 B USD | 1,15 B USD |
