...
|---|---|---|---|
| **21.09.2026 20:17 UTC** | **135** | **26.2 КБ** | **29** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260921_201754.csv`](./crypto_screener_20260921_201754.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `86 716,18 USD` | 🟢 +6,90% | 1,74 T USD | 51,39 B USD |
| **2** | **ETH** | `2 772,16 USD` | 🟢 +5,38% | 338,39 B USD | 24,16 B USD |
| **3** | **USDT** | `0,99991 USD` | 🟢 +0,02% | 183,37 B USD | 110,93 B USD |
| **4** | **BNB** | `801,63 USD` | 🟢 +4,41% | 106,75 B USD | 2,65 B USD |
| **5** | **XRP** | `1,5119 USD` | 🟢 +7,26% | 95,07 B USD | 5,49 B USD |
| **6** | **USDC** | `0,99972 USD` | −0,01% | 74,72 B USD | 22,6 B USD |
| **7** | **SOL** | `118,56 USD` | 🟢 +7,61% | 69,65 B USD | 6,41 B USD |
| **8** | **TRX** | `0,34417 USD` | 🟢 +0,36% | 32,68 B USD | 445,97 M USD |
| **9** | **ZEC** | `1 470,26 USD` | −3,03% | 24,82 B USD | 1,56 B USD |
| **10** | **HYPE** | `93,123 USD` | 🟢 +0,47% | 23,41 B USD | 1,21 B USD |
