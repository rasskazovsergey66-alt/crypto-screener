...
|---|---|---|---|
| **24.09.2026 17:31 UTC** | **135** | **25.7 КБ** | **40** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260924_173107.csv`](./crypto_screener_20260924_173107.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `84 337,93 USD` | 🟢 +0,41% | 1,69 T USD | 37,75 B USD |
| **2** | **ETH** | `2 682,58 USD` | 🟢 +0,91% | 327,48 B USD | 13,22 B USD |
| **3** | **USDT** | `0,99967 USD` | −0,01% | 183,48 B USD | 81,96 B USD |
| **4** | **BNB** | `780,03 USD` | 🟢 +1,92% | 103,87 B USD | 1,6 B USD |
| **5** | **XRP** | `1,5390 USD` | 🟢 +2,78% | 96,77 B USD | 4,66 B USD |
| **6** | **USDC** | `1,00000 USD` | 🟢 +0,01% | 75,23 B USD | 17,71 B USD |
| **7** | **SOL** | `117,13 USD` | 🟢 +2,63% | 68,82 B USD | 3,82 B USD |
| **8** | **TRX** | `0,34097 USD` | 🟢 +0,44% | 32,38 B USD | 525,09 M USD |
| **9** | **ZEC** | `1 556,08 USD` | 🟢 +2,29% | 26,27 B USD | 1,31 B USD |
| **10** | **HYPE** | `93,797 USD` | 🟢 +0,77% | 23,57 B USD | 1,23 B USD |
