...
|---|---|---|---|
| **18.09.2026 16:11 UTC** | **135** | **26.2 КБ** | **14** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260918_161141.csv`](./crypto_screener_20260918_161141.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `80 718,48 USD` | 🟢 +5,28% | 1,62 T USD | 33,36 B USD |
| **2** | **ETH** | `2 589,56 USD` | 🟢 +4,90% | 316,08 B USD | 16,93 B USD |
| **3** | **USDT** | `0,99950 USD` | 🟢 +0,04% | 183,35 B USD | 81,66 B USD |
| **4** | **BNB** | `759,28 USD` | 🟢 +4,45% | 101,11 B USD | 2,01 B USD |
| **5** | **XRP** | `1,3800 USD` | 🟢 +5,65% | 86,77 B USD | 3,68 B USD |
| **6** | **USDC** | `0,99952 USD` | −0,04% | 73,88 B USD | 15,68 B USD |
| **7** | **SOL** | `111,09 USD` | 🟢 +9,83% | 65,24 B USD | 5,16 B USD |
| **8** | **TRX** | `0,33956 USD` | 🟢 +1,64% | 32,24 B USD | 381,24 M USD |
| **9** | **ZEC** | `1 473,67 USD` | 🟢 +0,16% | 24,87 B USD | 2,23 B USD |
| **10** | **HYPE** | `91,544 USD` | 🟢 +11,27% | 23,02 B USD | 1,56 B USD |
