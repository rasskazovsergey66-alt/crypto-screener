...
|---|---|---|---|
| **22.09.2026 03:37 UTC** | **135** | **25.6 КБ** | **30** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260922_033704.csv`](./crypto_screener_20260922_033704.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `85 535,37 USD` | 🟢 +5,02% | 1,72 T USD | 57,64 B USD |
| **2** | **ETH** | `2 734,79 USD` | 🟢 +2,63% | 333,84 B USD | 26,11 B USD |
| **3** | **USDT** | `0,99976 USD` | 🟢 +0,01% | 183,34 B USD | 121,64 B USD |
| **4** | **BNB** | `789,24 USD` | 🟢 +1,68% | 105,1 B USD | 2,69 B USD |
| **5** | **XRP** | `1,5171 USD` | 🟢 +6,78% | 95,39 B USD | 7,02 B USD |
| **6** | **USDC** | `0,99993 USD` | −0,01% | 74,76 B USD | 24,35 B USD |
| **7** | **SOL** | `116,70 USD` | 🟢 +4,53% | 68,55 B USD | 6,82 B USD |
| **8** | **TRX** | `0,34750 USD` | 🟢 +1,29% | 33 B USD | 479,51 M USD |
| **9** | **ZEC** | `1 461,23 USD` | −3,52% | 24,67 B USD | 1,44 B USD |
| **10** | **HYPE** | `92,704 USD` | −0,62% | 23,3 B USD | 1,25 B USD |
