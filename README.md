...
|---|---|---|---|
| **15.09.2026 11:11 UTC** | **135** | **26.1 КБ** | **1** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260915_141133.csv`](./crypto_screener_20260915_141133.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `75 778,73 USD` | −1,46% | 1,52 T USD | 38,93 B USD |
| **2** | **ETH** | `2 401,29 USD` | −2,93% | 293,08 B USD | 19,33 B USD |
| **3** | **USDT** | `0,99911 USD` | −0,05% | 183,28 B USD | 80,69 B USD |
| **4** | **BNB** | `707,33 USD` | −1,33% | 94,19 B USD | 1,53 B USD |
| **5** | **XRP** | `1,2852 USD` | −7,98% | 80,81 B USD | 6,68 B USD |
| **6** | **USDC** | `1,0000 USD` | −0,01% | 73,73 B USD | 19,52 B USD |
| **7** | **SOL** | `97,120 USD` | −3,45% | 57,02 B USD | 3,77 B USD |
| **8** | **TRX** | `0,33472 USD` | −0,96% | 31,78 B USD | 521,84 M USD |
| **9** | **ZEC** | `1 184,13 USD` | 🟢 +3,48% | 19,98 B USD | 1,17 B USD |
| **10** | **HYPE** | `77,738 USD` | −1,31% | 19,56 B USD | 858,65 M USD |
