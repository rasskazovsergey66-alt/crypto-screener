...
|---|---|---|---|
| **19.09.2026 17:10 UTC** | **135** | **26.3 КБ** | **19** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260919_171041.csv`](./crypto_screener_20260919_171041.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `81 778,89 USD` | 🟢 +1,20% | 1,64 T USD | 27,22 B USD |
| **2** | **ETH** | `2 651,70 USD` | 🟢 +2,26% | 323,67 B USD | 16,15 B USD |
| **3** | **USDT** | `0,99969 USD` | 🟢 +0,01% | 183,33 B USD | 74,38 B USD |
| **4** | **BNB** | `768,25 USD` | 🟢 +1,42% | 102,3 B USD | 1,74 B USD |
| **5** | **XRP** | `1,4396 USD` | 🟢 +4,23% | 90,52 B USD | 4,46 B USD |
| **6** | **USDC** | `0,99987 USD` | 🟢 +0,04% | 74,19 B USD | 12,67 B USD |
| **7** | **SOL** | `112,14 USD` | 🟢 +0,34% | 65,87 B USD | 4,47 B USD |
| **8** | **TRX** | `0,33954 USD` | 🟢 +0,35% | 32,24 B USD | 428,7 M USD |
| **9** | **ZEC** | `1 502,60 USD` | 🟢 +3,76% | 25,36 B USD | 1,66 B USD |
| **10** | **HYPE** | `93,289 USD` | 🟢 +2,49% | 23,46 B USD | 1,26 B USD |
