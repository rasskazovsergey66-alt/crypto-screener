...
|---|---|---|---|
| **19.09.2026 05:24 UTC** | **135** | **26.1 КБ** | **18** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260919_052400.csv`](./crypto_screener_20260919_052400.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `81 042,21 USD` | 🟢 +4,65% | 1,63 T USD | 41,13 B USD |
| **2** | **ETH** | `2 626,65 USD` | 🟢 +5,81% | 320,61 B USD | 22,76 B USD |
| **3** | **USDT** | `0,99969 USD` | 🟢 +0,05% | 183,33 B USD | 99,33 B USD |
| **4** | **BNB** | `763,08 USD` | 🟢 +1,62% | 101,61 B USD | 2,18 B USD |
| **5** | **XRP** | `1,4228 USD` | 🟢 +7,86% | 89,46 B USD | 4,89 B USD |
| **6** | **USDC** | `0,99988 USD` | 🟢 +0,01% | 74,32 B USD | 18,23 B USD |
| **7** | **SOL** | `112,81 USD` | 🟢 +7,10% | 66,25 B USD | 6,56 B USD |
| **8** | **TRX** | `0,33818 USD` | 🟢 +0,71% | 32,11 B USD | 437,31 M USD |
| **9** | **ZEC** | `1 548,84 USD` | 🟢 +2,31% | 26,14 B USD | 2,03 B USD |
| **10** | **HYPE** | `92,319 USD` | 🟢 +5,48% | 23,22 B USD | 1,74 B USD |
