...
|---|---|---|---|
| **24.09.2026 09:03 UTC** | **135** | **25.7 КБ** | **39** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260924_090321.csv`](./crypto_screener_20260924_090321.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `83 613,12 USD` | −2,72% | 1,68 T USD | 44,43 B USD |
| **2** | **ETH** | `2 669,64 USD` | −2,49% | 325,9 B USD | 16,44 B USD |
| **3** | **USDT** | `0,99970 USD` | −0,02% | 183,49 B USD | 97,07 B USD |
| **4** | **BNB** | `769,90 USD` | −2,21% | 102,52 B USD | 1,93 B USD |
| **5** | **XRP** | `1,4809 USD` | −7,34% | 93,12 B USD | 6,51 B USD |
| **6** | **USDC** | `0,99993 USD` | ⚪ +0,00% | 75,43 B USD | 21,17 B USD |
| **7** | **SOL** | `114,09 USD` | −2,84% | 67,04 B USD | 5,08 B USD |
| **8** | **TRX** | `0,34053 USD` | −0,74% | 32,34 B USD | 539,25 M USD |
| **9** | **ZEC** | `1 510,57 USD` | −6,48% | 25,5 B USD | 2,02 B USD |
| **10** | **HYPE** | `92,025 USD` | −3,90% | 23,12 B USD | 1,12 B USD |
