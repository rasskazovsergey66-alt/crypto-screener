...
|---|---|---|---|
| **26.09.2026 09:12 UTC** | **135** | **25.8 КБ** | **47** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260926_091207.csv`](./crypto_screener_20260926_091207.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `84 102,30 USD` | −0,57% | 1,69 T USD | 32,31 B USD |
| **2** | **ETH** | `2 686,43 USD` | −0,26% | 327,96 B USD | 12,35 B USD |
| **3** | **USDT** | `0,99979 USD` | ⚪ +0,00% | 183,78 B USD | 78,84 B USD |
| **4** | **BNB** | `772,56 USD` | −0,43% | 102,87 B USD | 1,52 B USD |
| **5** | **XRP** | `1,5435 USD` | −0,13% | 97,05 B USD | 6,9 B USD |
| **6** | **USDC** | `0,99993 USD` | 🟢 +0,02% | 75,41 B USD | 16,44 B USD |
| **7** | **SOL** | `120,41 USD` | 🟢 +2,51% | 70,77 B USD | 5,91 B USD |
| **8** | **TRX** | `0,33689 USD` | −0,28% | 31,99 B USD | 370,45 M USD |
| **9** | **ZEC** | `1 524,89 USD` | −3,52% | 25,75 B USD | 1,24 B USD |
| **10** | **HYPE** | `91,656 USD` | −1,98% | 23,02 B USD | 920,72 M USD |
