...
|---|---|---|---|
| **18.09.2026 17:04 UTC** | **135** | **26.1 КБ** | **15** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260918_170426.csv`](./crypto_screener_20260918_170426.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `80 746,03 USD` | 🟢 +5,08% | 1,62 T USD | 33,36 B USD |
| **2** | **ETH** | `2 588,54 USD` | 🟢 +4,63% | 315,95 B USD | 16,93 B USD |
| **3** | **USDT** | `0,99965 USD` | 🟢 +0,05% | 183,38 B USD | 81,66 B USD |
| **4** | **BNB** | `757,02 USD` | 🟢 +3,86% | 100,81 B USD | 2,01 B USD |
| **5** | **XRP** | `1,3763 USD` | 🟢 +5,26% | 86,54 B USD | 3,68 B USD |
| **6** | **USDC** | `0,99940 USD` | −0,05% | 73,87 B USD | 15,68 B USD |
| **7** | **SOL** | `111,60 USD` | 🟢 +9,92% | 65,54 B USD | 5,16 B USD |
| **8** | **TRX** | `0,33845 USD` | 🟢 +1,40% | 32,14 B USD | 381,24 M USD |
| **9** | **ZEC** | `1 443,20 USD` | −2,04% | 24,35 B USD | 2,23 B USD |
| **10** | **HYPE** | `90,753 USD` | 🟢 +10,02% | 22,83 B USD | 1,56 B USD |
