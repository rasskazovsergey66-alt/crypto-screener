...
|---|---|---|---|
| **17.09.2026 04:12 UTC** | **135** | **25.4 КБ** | **8** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260917_041256.csv`](./crypto_screener_20260917_041256.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `76 270,21 USD` | 🟢 +0,57% | 1,53 T USD | 30,25 B USD |
| **2** | **ETH** | `2 429,76 USD` | 🟢 +1,15% | 296,57 B USD | 15,94 B USD |
| **3** | **USDT** | `0,99908 USD` | −0,01% | 183,27 B USD | 69,95 B USD |
| **4** | **BNB** | `724,20 USD` | 🟢 +1,37% | 96,43 B USD | 1,52 B USD |
| **5** | **XRP** | `1,2982 USD` | −0,33% | 81,63 B USD | 4,11 B USD |
| **6** | **USDC** | `1,0000 USD` | ⚪ 0,00% | 73,71 B USD | 17,7 B USD |
| **7** | **SOL** | `99,599 USD` | 🟢 +2,32% | 58,49 B USD | 3,16 B USD |
| **8** | **TRX** | `0,33558 USD` | 🟢 +0,59% | 31,86 B USD | 396,76 M USD |
| **9** | **ZEC** | `1 368,08 USD` | 🟢 +20,41% | 23,08 B USD | 2,42 B USD |
| **10** | **HYPE** | `79,228 USD` | 🟢 +2,45% | 19,93 B USD | 884,01 M USD |
