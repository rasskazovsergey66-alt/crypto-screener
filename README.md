...
|---|---|---|---|
| **24.09.2026 19:50 UTC** | **135** | **25.7 КБ** | **41** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260924_195013.csv`](./crypto_screener_20260924_195013.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `84 482,33 USD` | −0,05% | 1,7 T USD | 37,75 B USD |
| **2** | **ETH** | `2 698,20 USD` | 🟢 +0,71% | 329,39 B USD | 13,22 B USD |
| **3** | **USDT** | `0,99962 USD` | −0,02% | 183,47 B USD | 81,96 B USD |
| **4** | **BNB** | `779,62 USD` | 🟢 +1,49% | 103,81 B USD | 1,6 B USD |
| **5** | **XRP** | `1,5261 USD` | 🟢 +1,61% | 95,96 B USD | 4,66 B USD |
| **6** | **USDC** | `1,00003 USD` | 🟢 +0,01% | 75,16 B USD | 17,71 B USD |
| **7** | **SOL** | `117,43 USD` | 🟢 +2,33% | 69 B USD | 3,82 B USD |
| **8** | **TRX** | `0,34067 USD` | −0,01% | 32,35 B USD | 525,09 M USD |
| **9** | **ZEC** | `1 561,06 USD` | 🟢 +2,79% | 26,36 B USD | 1,31 B USD |
| **10** | **HYPE** | `94,380 USD` | 🟢 +0,70% | 23,71 B USD | 1,23 B USD |
