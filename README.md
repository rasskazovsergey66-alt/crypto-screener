...
|---|---|---|---|
| **17.09.2026 06:20 UTC** | **135** | **25.4 КБ** | **9** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260917_062009.csv`](./crypto_screener_20260917_062009.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `76 341,67 USD` | 🟢 +0,53% | 1,53 T USD | 30,25 B USD |
| **2** | **ETH** | `2 436,93 USD` | 🟢 +1,42% | 297,44 B USD | 15,94 B USD |
| **3** | **USDT** | `0,99902 USD` | −0,01% | 183,26 B USD | 69,95 B USD |
| **4** | **BNB** | `724,44 USD` | 🟢 +1,50% | 96,47 B USD | 1,52 B USD |
| **5** | **XRP** | `1,2945 USD` | −0,22% | 81,4 B USD | 4,11 B USD |
| **6** | **USDC** | `1,0000 USD` | ⚪ 0,00% | 73,7 B USD | 17,7 B USD |
| **7** | **SOL** | `99,453 USD` | 🟢 +2,31% | 58,4 B USD | 3,16 B USD |
| **8** | **TRX** | `0,33549 USD` | 🟢 +0,31% | 31,86 B USD | 396,76 M USD |
| **9** | **ZEC** | `1 356,58 USD` | 🟢 +16,30% | 22,89 B USD | 2,42 B USD |
| **10** | **HYPE** | `79,017 USD` | 🟢 +2,09% | 19,88 B USD | 884,01 M USD |
