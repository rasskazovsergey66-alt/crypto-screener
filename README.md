...
|---|---|---|---|
| **21.09.2026 11:09 UTC** | **135** | **26.3 КБ** | **27** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260921_110927.csv`](./crypto_screener_20260921_110927.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `84 490,92 USD` | 🟢 +5,18% | 1,7 T USD | 21,55 B USD |
| **2** | **ETH** | `2 719,10 USD` | 🟢 +5,77% | 331,91 B USD | 12,8 B USD |
| **3** | **USDT** | `0,99975 USD` | 🟢 +0,02% | 183,34 B USD | 61,68 B USD |
| **4** | **BNB** | `786,22 USD` | 🟢 +4,98% | 104,69 B USD | 1,74 B USD |
| **5** | **XRP** | `1,4946 USD` | 🟢 +8,46% | 93,98 B USD | 2,84 B USD |
| **6** | **USDC** | `0,99989 USD` | 🟢 +0,01% | 74,39 B USD | 11,84 B USD |
| **7** | **SOL** | `116,23 USD` | 🟢 +7,52% | 68,28 B USD | 3,41 B USD |
| **8** | **TRX** | `0,34447 USD` | 🟢 +0,58% | 32,71 B USD | 460,4 M USD |
| **9** | **ZEC** | `1 527,19 USD` | 🟢 +6,03% | 25,78 B USD | 1,43 B USD |
| **10** | **HYPE** | `95,346 USD` | 🟢 +5,02% | 23,97 B USD | 832,29 M USD |
