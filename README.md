...
|---|---|---|---|
| **19.09.2026 04:12 UTC** | **135** | **26.2 КБ** | **17** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260919_041206.csv`](./crypto_screener_20260919_041206.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `81 185,94 USD` | 🟢 +5,14% | 1,63 T USD | 41,13 B USD |
| **2** | **ETH** | `2 624,34 USD` | 🟢 +6,11% | 320,33 B USD | 22,76 B USD |
| **3** | **USDT** | `0,99969 USD` | 🟢 +0,06% | 183,33 B USD | 99,33 B USD |
| **4** | **BNB** | `761,75 USD` | 🟢 +1,72% | 101,43 B USD | 2,18 B USD |
| **5** | **XRP** | `1,4243 USD` | 🟢 +8,08% | 89,56 B USD | 4,89 B USD |
| **6** | **USDC** | `0,99989 USD` | −0,00% | 74,33 B USD | 18,23 B USD |
| **7** | **SOL** | `113,37 USD` | 🟢 +8,36% | 66,58 B USD | 6,56 B USD |
| **8** | **TRX** | `0,33868 USD` | 🟢 +0,82% | 32,16 B USD | 437,31 M USD |
| **9** | **ZEC** | `1 534,17 USD` | 🟢 +1,35% | 25,89 B USD | 2,03 B USD |
| **10** | **HYPE** | `93,587 USD` | 🟢 +8,23% | 23,54 B USD | 1,74 B USD |
