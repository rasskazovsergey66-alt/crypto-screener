...
|---|---|---|---|
| **17.09.2026 16:13 UTC** | **135** | **25.4 КБ** | **10** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260917_161311.csv`](./crypto_screener_20260917_161311.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `76 646,79 USD` | 🟢 +1,13% | 1,54 T USD | 29 B USD |
| **2** | **ETH** | `2 468,73 USD` | 🟢 +3,07% | 301,32 B USD | 14,99 B USD |
| **3** | **USDT** | `0,99922 USD` | −0,01% | 183,3 B USD | 70,02 B USD |
| **4** | **BNB** | `726,93 USD` | 🟢 +2,08% | 96,8 B USD | 1,49 B USD |
| **5** | **XRP** | `1,3057 USD` | 🟢 +3,05% | 82,1 B USD | 3,92 B USD |
| **6** | **USDC** | `0,9999 USD` | 🟢 +0,01% | 73,61 B USD | 17,88 B USD |
| **7** | **SOL** | `101,22 USD` | 🟢 +4,12% | 59,44 B USD | 3,29 B USD |
| **8** | **TRX** | `0,33398 USD` | −0,59% | 31,71 B USD | 331,69 M USD |
| **9** | **ZEC** | `1 468,97 USD` | 🟢 +17,19% | 24,79 B USD | 2,92 B USD |
| **10** | **HYPE** | `82,096 USD` | 🟢 +4,18% | 20,65 B USD | 904,15 M USD |
