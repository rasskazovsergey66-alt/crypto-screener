...
|---|---|---|---|
| **20.09.2026 09:07 UTC** | **135** | **25.8 КБ** | **22** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260920_090733.csv`](./crypto_screener_20260920_090733.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `80 278,14 USD` | −1,42% | 1,61 T USD | 22,25 B USD |
| **2** | **ETH** | `2 576,66 USD` | −2,83% | 314,52 B USD | 10,52 B USD |
| **3** | **USDT** | `0,99960 USD` | −0,01% | 183,31 B USD | 61,33 B USD |
| **4** | **BNB** | `750,29 USD` | −2,32% | 99,91 B USD | 1,54 B USD |
| **5** | **XRP** | `1,3797 USD` | −2,55% | 86,75 B USD | 3,56 B USD |
| **6** | **USDC** | `0,99987 USD` | −0,00% | 74,21 B USD | 10,06 B USD |
| **7** | **SOL** | `108,18 USD` | −3,60% | 63,54 B USD | 3,06 B USD |
| **8** | **TRX** | `0,34145 USD` | 🟢 +0,95% | 32,42 B USD | 367,8 M USD |
| **9** | **ZEC** | `1 440,93 USD` | −7,22% | 24,32 B USD | 1,27 B USD |
| **10** | **HYPE** | `90,661 USD` | −1,41% | 22,8 B USD | 936,73 M USD |
