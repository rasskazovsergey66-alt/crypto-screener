...
|---|---|---|---|
| **23.09.2026 17:06 UTC** | **135** | **25.7 КБ** | **36** снапшотов |

**⭐ Свежий срез:** [`crypto_screener_20260923_170655.csv`](./crypto_screener_20260923_170655.csv)  
...
|:---:|:---|:---:|:---:|:---:|:---:|
| **1** | **BTC** | `83 869,90 USD` | −2,99% | 1,68 T USD | 43,2 B USD |
| **2** | **ETH** | `2 656,74 USD` | −3,25% | 324,32 B USD | 17,85 B USD |
| **3** | **USDT** | `0,99980 USD` | −0,01% | 183,43 B USD | 101,7 B USD |
| **4** | **BNB** | `763,70 USD` | −3,23% | 101,69 B USD | 1,95 B USD |
| **5** | **XRP** | `1,4904 USD` | −4,92% | 93,72 B USD | 8,32 B USD |
| **6** | **USDC** | `0,99988 USD` | 🟢 +0,01% | 75,25 B USD | 21,39 B USD |
| **7** | **SOL** | `113,98 USD` | −3,12% | 66,97 B USD | 5,17 B USD |
| **8** | **TRX** | `0,33888 USD` | −0,57% | 32,18 B USD | 535,6 M USD |
| **9** | **ZEC** | `1 529,35 USD` | −1,69% | 25,82 B USD | 2,42 B USD |
| **10** | **HYPE** | `92,347 USD` | −3,28% | 23,21 B USD | 1,18 B USD |
